...
{% assign pub_years = all_pubs | map: 'year' | uniq %}
      ...
      {% if pub.year == year %}
        <div class="publication">
          ...
          <div class="publication-links">
            {% if pub.abstract %}
              <a class="abstract-toggle" data-pub-id="all-{{ forloop.index }}">Abstract</a>
              <div class="abstract-content" id="abstract-all-{{ forloop.index }}" style="display: none;">
                {{ pub.abstract }}
              </div>
            {% endif %}

            {% if pub.bibtex %}
              <a class="bibtex-toggle" data-pub-id="all-{{ forloop.index }}">BibTeX</a>
              <div class="bibtex-content" id="bibtex-all-{{ forloop.index }}" style="display: none;">
                <pre><code>{{ pub.bibtex }}</code></pre>
                <button class="copy-bibtex" data-bibtex-id="all-{{ forloop.index }}">Copy to clipboard</button>
              </div>
            {% endif %}
